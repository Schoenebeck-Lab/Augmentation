...
RESULTS = AIxChem / "docs/buttar_norrby" / "AUG" / "AGN"   # Adjust the path to where the results are located
...
hyperparameters = {
    0.05: {"random_state": 42, "n_estimators": 2000, "max_depth": None, "min_samples_split": 2, "min_samples_leaf": 1,},
    0.1: {"random_state": 42, "n_estimators": 2000, "max_depth": None, "min_samples_split": 2, "min_samples_leaf": 1,},
    0.2: {"random_state": 42, "n_estimators": 2000, "max_depth": 10, "min_samples_split": 2, "min_samples_leaf": 1,},
    0.3: {"random_state": 42, "n_estimators": 2000, "max_depth": None, "min_samples_split": 2, "min_samples_leaf": 1,},
    0.4: {"random_state": 42, "n_estimators": 2000, "max_depth": 20, "min_samples_split": 2, "min_samples_leaf": 1,},
    0.5: {"random_state": 42, "n_estimators": 2000, "max_depth": 20, "min_samples_split": 2, "min_samples_leaf": 1,},
    0.6: {"random_state": 42, "n_estimators": 500, "max_depth": 20, "min_samples_split": 2, "min_samples_leaf": 1,},
    0.7: {"random_state": 42, "n_estimators": 2000, "max_depth": 20, "min_samples_split": 2, "min_samples_leaf": 1,},
    0.8: {"random_state": 42, "n_estimators": 1000, "max_depth": 20, "min_samples_split": 2, "min_samples_leaf": 1,},
    0.9: {"random_state": 42, "n_estimators": 200, "max_depth": 20, "min_samples_split": 2, "min_samples_leaf": 1,},
    1.0: {"random_state": 42, "n_estimators": 2000, "max_depth": 20, "min_samples_split": 2, "min_samples_leaf": 1,},
}

# Load the data & clean it
dataset = Dataset(DATA, target=LABELS, sep=",").dropna(axis=0).shuffle(random_state=42)
# Drop the index column
dataset.X.drop(columns=["Unnamed: 0"], inplace=True)
